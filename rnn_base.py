#This is the modified version of rnn_base.py from snorkel/learning/pytorch/rnn directory.
#It is adjusted to accepted candidates that only have one element.
