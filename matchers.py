#This is the modified version of matchers.py from snorkel. It includes AdjectiveMatcher added by me.
#Swap this file in the snorkel directory of your virtual environment. 
...
class AdjectiveMatcher(RegexMatchEach):
    """
    Matches Spans that are adjectives as identified by CoreNLP.

    A convenience class for setting up a RegexMatchEach to match spans
    for which each token was tagged as an adjective.
    """
    def __init__(self, *children, **kwargs):
        kwargs['attrib'] = 'pos_tags'
        kwargs['rgx'] = 'JJ'
        super(AdjectiveMatcher, self).__init__(*children, **kwargs)
